...
from neehproject import LOGGER
...
def git():
    ...
    try:
        repo = Repo()
        LOGGER("neehproject").info(f"Git Client Found")
    except GitCommandError:
        LOGGER("neehproject").info(f"Invalid Git Command")
        ...
        LOGGER("neehproject").info("Fetched Latest Updates")
    ...
    if is_heroku:
        if HEROKU_API_KEY and HEROKU_APP_NAME:
            try:
                ...
                LOGGER("neehproject").info(f"Heroku App Configured")
